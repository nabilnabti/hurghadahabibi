...
export const metadata: Metadata = {
  title: "A propos - Hurghada Habibi | Votre agence francophone en Egypte",
  description:
    ...
    <main className="flex-1">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1A1A1A] via-[#2a2a2a] to-[#1A1A1A]">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute -left-20 -top-20 h-96 w-96 rounded-full bg-[#E8461C] blur-[120px]" />
          <div className="absolute -right-20 bottom-0 h-96 w-96 rounded-full bg-[#4AABE0] blur-[120px]" />
        </div>
        <div className="relative mx-auto max-w-7xl px-4 py-20 sm:py-28 lg:px-8 lg:py-36">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h1 className="text-3xl font-extrabold leading-tight text-white sm:text-4xl lg:text-5xl">
              A propos de{" "}
              <span className="bg-gradient-to-r from-[#E8461C] to-[#ff6b47] bg-clip-text text-transparent">
                Hurghada Habibi
              </span>
            </h1>
            <p className="mt-6 text-base leading-relaxed text-white/70 sm:text-lg">
              Votre agence de voyage francophone N°1 en Egypte. Des experiences
      ...
      <section className="bg-white py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
            <div>
              <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-[#E8461C]">
                Notre histoire
              </p>
              ...
              <div className="mt-6 space-y-4 text-base leading-relaxed text-gray-600 sm:text-lg">
                ...
                <p>
                  ...
                  <span className="font-semibold text-[#E8461C]">Hurghada Habibi</span>.
                </p>
                <p>
            ...
            <div className="relative">
              <div className="aspect-[4/3] overflow-hidden rounded-2xl bg-gradient-to-br from-[#4AABE0]/20 to-[#E8461C]/20">
                <div className="flex h-full items-center justify-center">
                  <div className="text-center">
                    <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-[#E8461C]/10">
                      <svg className="h-10 w-10 text-[#E8461C]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
                        <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z" />
                      </svg>
                    </div>
                    <p className="text-lg font-bold text-[#1A1A1A]">Notre equipe sur le terrain</p>
                    <p className="mt-1 text-sm text-gray-500">Hurghada, Egypte</p>
                  </div>
                </div>
              </div>
              <div className="absolute -bottom-4 -right-4 hidden rounded-xl bg-[#E8461C] px-6 py-4 text-white shadow-xl sm:block">
                <p className="text-2xl font-extrabold">+10 ans</p>
                <p className="text-sm font-medium text-white/80">d&apos;experience</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16 sm:py-20 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-2 text-sm font-semibold uppercase tracking-widest text-[#4AABE0]">
              Notre mission
            </p>
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-3 sm:gap-8">
            {missions.map((mission) => (
              <div
                key={mission.title}
                className="group rounded-2xl bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg sm:p-8"
              >
                <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-xl bg-[#E8461C]/10 text-[#E8461C] transition-colors group-hover:bg-[#E8461C] group-hover:text-white">
                  {mission.icon}
                </div>
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.label} className="text-center">
                <p className="text-2xl font-extrabold text-[#E8461C] sm:text-3xl lg:text-4xl">
                  {stat.value}
                </p>
        ...
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <div className="mt-12 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {values.map((v) => (
              <div
                key={v.title}
                className="rounded-2xl border border-gray-100 p-6 text-center transition-all duration-300 hover:border-[#4AABE0]/30 hover:shadow-md"
              >
                <div className="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#4AABE0]/10 text-[#4AABE0]">
                  {v.icon}
                </div>
                <h3 className="mb-2 text-base font-bold text-[#1A1A1A] sm:text-lg">{v.title}</h3>
      ...
      {/* CTA WhatsApp */}
      <section className="bg-gradient-to-r from-[#E8461C] to-[#ff6b47] py-16 sm:py-20">
        <div className="mx-auto max-w-7xl px-4 text-center lg:px-8">
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              className="inline-flex w-full items-center justify-center gap-3 rounded-full bg-white px-8 py-4 text-base font-bold text-[#E8461C] shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl active:scale-95 sm:w-auto"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex w-full items-center justify-center rounded-full border-2 border-white px-8 py-4 text-base font-bold text-white transition-all duration-200 hover:bg-white/10 active:scale-95 sm:w-auto"
            >
