...
export const metadata: Metadata = {
  title: "Exploration & Bien-etre | Hurghada Habibi V2",
  description:
    "Safaris dans le desert, quad, buggy, cheval, spa et spectacles. Decouvrez nos activites d'exploration et bien-etre a Hurghada et Marsa Alam.",
};

export default function V2ExplorationBienEtrePage() {
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              <p className="text-base sm:text-lg text-white/70 leading-relaxed">
                Safaris dans le desert, balades en quad ou a cheval, spa de luxe
                et spectacles nocturnes. Des aventures terrestres inoubliables
                sous le soleil egyptien.
              </p>
            </div>
          </div>
        </section>
